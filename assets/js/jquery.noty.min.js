...
(function(e) {
    e.noty = function(t, n) {
        ...
        r.addQueue = function() {
            ...
            t || (r.options.force ? e.noty.queue.unshift({options: r.options}) : e.noty.queue.push({options: r.options}));
            return r.render(t)
        };
        r.render = function(t) {
        ...
        r.show = function(t) {
            ...
            i.one("noty.close", function(t) {
                ...
                i.clearQueue().stop().animate(i.data("noty_options").animateClose, i.data("noty_options").speed, i.data("noty_options").easing, i.data("noty_options").onClosed).promise().done(function() {
                    if (e.inArray(i.data("noty_options").layout, e.noty.growls) > -1)
                        i.parent().remove();
                    else {
                        i.remove();
                        e.noty.available = !0;
    ...
    e.noty.close = function(t) {
        for (var n = 0; n < e.noty.queue.length; )
            e.noty.queue[n].options.id == t ? e.noty.queue.splice(t, 1) : n++;
    ...
    e.noty.reCenter = function(t) {
        t.css({left: (e(window).width() - t.outerWidth()) / 2 + "px"})
    };
