 ...
 */(function(e) {
    ...
    f.prototype = {constructor: f, _parseAttr: function(e, i) {
            var s = this, a = s.$elementOrig;
            ...
            var s = this;
            var u = o(s.$elementOrig.attr("id")) ? a() : "kvstar-" + s.$elementOrig.attr("id");
            ...
            s.$elementOrig.clone(true).attr({id: u, type: "range"}).insertBefore(s.$elementOrig);
            s.$element = e("#" + u);
            s.$element.attr({min: s.min, max: s.max, step: s.step, disabled: s.disabled, readonly: s.readonly});
            s.$elementOrig.hide()
        }, polyfill: function(t) {
            var n = this, r = e("<select>"), i = n.$element;
            i.before(r);
            for (var s in t) {
                r.append(e("<option>").attr("value", s).text(t[s]))
            }
            r.attr({"class": i.attr("class"), style: i.attr("style")});
            i.hide();
            ...
            var e = this, t = e.renderClear(), n = e.renderCaption(), r = e.rtl ? "rating-container-rtl" : "rating-container", i = e.getStars();
            r += e.glyphicon ? " rating-gly" : " rating-uni";
            ...
            if (!o(e.$clearElement)) {
                e.$clearElement.removeClass(t).addClass(t).attr({title: e.clearButtonTitle});
            ...
            if (!o(e.$captionElement)) {
                e.$captionElement.removeClass("caption").addClass("caption").attr({title: e.clearCaption});
            ...
            var e = this, t = e.min, n = e.max, r = e.step, i = e.$element.val(), s = 0, u = e.fetchCaption(i);
            if (i == n) {
                s = 100
            } else if (!o(i) && i >= t) {
                s = Math.round(i / n * 100)
            }
            if (e.rtl) {
                s = 100 - s
            }
    ...
    e.fn.rating = function(t) {
        ...
        return this.each(function() {
            var r = e(this), i = r.data("rating"), s = typeof t === "object" && t;
            if (!i) {
