...
jQuery(document).ready(function(e) {
    if (e(".todo-actions").length) {
        e(".todo-actions > a").click(function() {
            if (e(this).find("i").attr("class") == "fa fa-square-o") {
                e(this).find("i").removeClass("fa fa-square-o").addClass("fa fa-check-square-o");
                e(this).parent().parent().find("span").css({
                    opacity: .25
                });
                e(this).parent().parent().find(".desc").css("text-decoration", "line-through")
            } else {
                e(this).find("i").removeClass("fa fa-check-square-o").addClass("fa fa-square-o");
                e(this).parent().parent().find("span").css({
                    opacity: 1
                });
