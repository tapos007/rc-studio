 ...
 * ========================================================= */!function(e) {
    ...
    t.prototype = {constructor: t, setColor: function(t) {
            ...
            e.each(r.stringParsers, function(e, i) {
                ...
                if (o) {
                    u === "hsla" ? n.value = r.RGBtoHSB.apply(null, r.HSLtoRGB.apply(null, o)) : n.value = r.RGBtoHSB.apply(null, o);
                    return!1
                }
            })
        }, setHue: function(e) {
    ...
    n.prototype = {constructor: n, show: function(t) {
            ...
            if (!this.isInput) {
                ...
                this.component && this.element.find("input").prop("value", this.format.call(this));
    ...
    e.fn.colorpicker = function(t, r) {
        return this.each(function() {
            var i = e(this), s = i.data("colorpicker"), o = typeof t == "object" && t;
            s || i.data("colorpicker", s = new n(this, e.extend({}, e.fn.colorpicker.defaults, o)));
            typeof t == "string" && s[t](r)
        })
    };
    ...
    var r = {translateFormats: {rgb: function() {
            ...
            }}, sliders: {saturation: {maxLeft: 100, maxTop: 100, callLeft: "setSaturation", callTop: "setLightness"}, hue: {maxLeft: 0, maxTop: 100, callLeft: !1, callTop: "setHue"}, alpha: {maxLeft: 0, maxTop: 100, callLeft: !1, callTop: "setAlpha"}}, RGBtoHSB: function(e, t, n, r) {
            e /= 255;
            t /= 255;
            n /= 255;
            var i, s, o, u;
            ...
            var o = 2 * n - s, u = e + 1 / 3, a = e, f = e - 1 / 3, l = Math.round(r.HueToRGB(o, s, u) * 255), c = Math.round(r.HueToRGB(o, s, a) * 255), h = Math.round(r.HueToRGB(o, s, f) * 255);
            return[l, c, h, i || 1]
