 ...
 */!function(e) {
    var t = function(t, n, r) {
        ...
        s = this.locale;
        if (i) {
            typeof n.locale == "object" && e.each(s, function(e, t) {
                s[e] = n.locale[e] || t
            });
        ...
        if (i) {
            ...
            if (typeof n.ranges == "object") {
                for (var u in n.ranges) {
                    var a = moment(n.ranges[u][0]), f = moment(n.ranges[u][1]);
                    this.minDate && a.isBefore(this.minDate) && (a = moment(this.minDate));
                    this.maxDate && f.isAfter(this.maxDate) && (f = moment(this.maxDate));
                    if (this.minDate && f.isBefore(this.minDate) || this.maxDate && a.isAfter(this.maxDate))
                        continue;
                    this.ranges[u] = [a, f]
                }
                var l = "<ul>";
        ...
        if (this.opens == "right") {
            var p = this.container.find(".calendar.left"), d = this.container.find(".calendar.right");
        ...
        if (!i || typeof n.startDate == "undefined" && typeof n.endDate == "undefined")
            if (e(this.element).is("input[type=text]")) {
                var v = e(this.element).val(), m = v.split(this.separator), a, f;
                if (m.length == 2) {
    ...
    t.prototype = {constructor: t, mousedown: function(e) {
            e.stopPropagation()
        }, updateView: function() {
            ...
            if (!this.element.val().length)
                return;
            var e = this.element.val().split(this.separator), t = moment(e[0], this.format), n = moment(e[1], this.format);
            if (t == null || n == null)
                return;
            if (n.isBefore(t))
                return;
            ...
            var n = e(t.target).attr("data-title"), r = n.substr(1, 1), i = n.substr(3, 1), s = e(t.target).parents(".calendar");
            ...
            var n = e(t.target).attr("data-title"), r = n.substr(1, 1), i = n.substr(3, 1), s = e(t.target).parents(".calendar");
            if (s.hasClass("left")) {
                var o = this.leftCalendar.calendar[r][i], u = this.endDate;
                if (typeof this.dateLimit == "object") {
                    var a = moment(o).add(this.dateLimit).startOf("day");
                    u.isAfter(a) && (u = a)
                }
            } else {
                var o = this.startDate, u = this.rightCalendar.calendar[r][i];
                if (typeof this.dateLimit == "object") {
            ...
            var n = e(t.target).closest(".calendar").hasClass("left"), r = this.container.find(".calendar.left");
            n || (r = this.container.find(".calendar.right"));
            var i = r.find(".monthselect").val(), s = r.find(".yearselect").val();
            n ? this.leftCalendar.month.month(i).year(s) : this.rightCalendar.month.month(i).year(s);
            this.updateCalendars()
        }, updateTime: function(t) {
            var n = e(t.target).closest(".calendar").hasClass("left"), r = this.container.find(".calendar.left");
            n || (r = this.container.find(".calendar.right"));
            var i = parseInt(r.find(".hourselect").val()), s = parseInt(r.find(".minuteselect").val());
            ...
            var s = moment([t, e, 1]), o = moment(s).subtract("month", 1).month(), u = moment(s).subtract("month", 1).year(), a = moment([u, o]).daysInMonth(), f = s.day(), l = [];
            for (var c = 0; c < 6; c++)
                l[c] = [];
            ...
            var r = e.month(), i = '<select class="monthselect">', s = !1, o = !1;
            for (var u = 0; u < 12; u++)
                (!s || u >= t.month()) && (!o || u <= n.month()) && (i += "<option value='" + u + "'" + (u === r ? " selected='selected'" : "") + ">" + this.locale.monthNames[u] + "</option>");
            i += "</select>";
            var a = e.year(), f = n && n.year() || a + 5, l = t && t.year() || a - 50, c = '<select class="yearselect">';
            for (var h = l; h <= f; h++)
            ...
            !r || r.isBefore(t[1][1]) ? s += '<th class="prev available"><i class="icon-arrow-left glyphicon glyphicon-arrow-left"></i></th>' : s += "<th></th>";
            ...
            !i || i.isAfter(t[1][1]) ? s += '<th class="next available"><i class="icon-arrow-right glyphicon glyphicon-arrow-right"></i></th>' : s += "<th></th>";
            s += "</tr>";
            s += "<tr>";
            ...
            for (var u = 0; u < 6; u++) {
                ...
                for (var a = 0; a < 7; a++) {
                    ...
                    if (r && t[u][a].isBefore(r) || i && t[u][a].isAfter(i))
                        f = " off disabled ";
            ...
            if (this.timePicker) {
                ...
                for (var d = c; d <= h; d++)
                    d == p ? s += '<option value="' + d + '" selected="selected">' + d + "</option>" : s += '<option value="' + d + '">' + d + "</option>";
                s += "</select> : ";
