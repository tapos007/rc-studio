 ...
 */(function(e, t, n, r) {
    function l(n, r) {
        this.w = e(t);
        this.el = e(n);
        this.options = e.extend({}, f, r);
        this.init()
    }
    var i = "ontouchstart"in t, s = function() {
        ...
        return!1
    }(), o = i ? "touchstart" : "mousedown", u = i ? "touchmove" : "mousemove", a = i ? "touchend" : "mouseup";
    eCancel = i ? "touchcancel" : "mouseup";
    var f = {listNodeName: "ol", itemNodeName: "li", rootClass: "dd", listClass: "dd-list", itemClass: "dd-item", dragClass: "dd-dragel", handleClass: "dd-handle", collapsedClass: "dd-collapsed", placeClass: "dd-placeholder", noDragClass: "dd-nodrag", emptyClass: "dd-empty", expandBtnHTML: '<button data-action="expand" type="button">Expand</button>', collapseBtnHTML: '<button data-action="collapse" type="button">Collapse</button>', group: 0, maxDepth: 5, threshold: 20};
    l.prototype = {init: function() {
            ...
            n.el.on("click", "button", function(t) {
                if (n.dragEl || !i && t.button !== 0)
                    return;
                var r = e(t.currentTarget), s = r.data("action"), o = r.parent(n.options.itemNodeName);
                s === "collapse" && n.collapseItem(o);
                s === "expand" && n.expandItem(o)
            });
            var r = function(t) {
                var r = e(t.target);
                ...
                if (!r.length || n.dragEl || !i && t.button !== 0 || i && t.touches.length !== 1)
                    return;
                t.preventDefault();
                n.dragStart(i ? t.touches[0] : t)
            }, s = function(e) {
                if (n.dragEl) {
                    e.preventDefault();
                    n.dragMove(i ? e.touches[0] : e)
                }
            }, f = function(e) {
                if (n.dragEl) {
                    e.preventDefault();
                    n.dragStop(i ? e.touches[0] : e)
                }
            };
            if (i) {
                n.el[0].addEventListener(o, r, !1);
                t.addEventListener(u, s, !1);
                t.addEventListener(a, f, !1);
                t.addEventListener(eCancel, f, !1)
            } else {
                n.el.on(o, r);
                n.w.on(u, s);
                n.w.on(a, f)
            ...
            step = function(t, n) {
                ...
                s.each(function() {
                    ...
                    o.length && (s.children = step(o, n + 1));
                    i.push(s)
                });
                return i
            };
            ...
            for (u = 0; u < f.length; u++) {
                ...
                a > this.dragDepth && (this.dragDepth = a)
            }
        }, dragStop: function(e) {
            ...
            if (c.dirAx !== h) {
                ...
                c.dirX !== 0 && c.dirX !== c.lastDirX && (c.distAxX = 0);
                c.distAxY += Math.abs(c.distY);
                c.dirY !== 0 && c.dirY !== c.lastDirY && (c.distAxY = 0)
            }
            c.dirAx = h;
            ...
            var p = !1;
            s || (this.dragEl[0].style.visibility = "hidden");
            this.pointEl = e(n.elementFromPoint(r.pageX - n.body.scrollLeft, r.pageY - (t.pageYOffset || n.documentElement.scrollTop)));
            s || (this.dragEl[0].style.visibility = "visible");
            this.pointEl.hasClass(l.handleClass) && (this.pointEl = this.pointEl.parent(l.itemNodeName));
            ...
            if (!c.dirAx || v || p) {
                ...
                if (p) {
                    ...
                    m ? this.pointEl.before(this.placeEl) : this.pointEl.after(this.placeEl);
                o.children().length || this.unsetParent(o.parent());
    ...
    e.fn.nestable = function(t) {
        ...
        n.each(function() {
            ...
            if (!n) {
                e(this).data("nestable", new l(this, t));
                e(this).data("nestable-id", (new Date).getTime())
            } else
                typeof t == "string" && typeof n[t] == "function" && (r = n[t]())
        });
        return r || n
    }
