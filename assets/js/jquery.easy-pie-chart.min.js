 ...
 */(function(e) {
    e.easyPieChart = function(t, n) {
        ...
        i = function(e, t) {
            ...
            n = function() {
                ...
                s.call(c, i);
                return f >= c.options.animate ? c.options.onStop.call(c, i, t) : u(n)
            };
            u(n)
        };
        o = function(e, t, n, r) {
    ...
    e.easyPieChart.defaultOptions = {barColor: "#ef1e25", trackColor: "#f2f2f2", scaleColor: "#dfe0e0", lineCap: "round", rotate: 0, size: 110, lineWidth: 3, animate: !1, delay: !1, onStart: e.noop, onStop: e.noop, onStep: e.noop};
