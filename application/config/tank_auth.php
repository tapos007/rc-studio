...
/*
  ...
  |--------------------------------------------------------------------------
 */
$config['website_name'] = 'Studionear';
$config['webmaster_email'] = 'webmaster@studionear.com';
...
$config['autologin_cookie_life'] = 60 * 60 * 24 * 3;
...
/*
  ...
  |--------------------------------------------------------------------------
 */
$config['captcha_path'] = 'public/dashboard/upl';
...
$config['recaptcha_public_key'] = '12asde';
$config['recaptcha_private_key'] = '345sdrgg';
