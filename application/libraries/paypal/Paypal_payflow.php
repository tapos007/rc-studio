...
/**
 * 	Angell EYE PayPal PayFlow CodeIgniter Library
 * 	An open source PHP library written to easily work with PayPal's PayFlow API's
 *
...
class PayPal_PayFlow extends PayPal_Pro {
