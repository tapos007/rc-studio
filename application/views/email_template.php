                    ...
                    <td><table border="0" bgcolor="#fff" align="center" cellspacing="0" cellpadding="0" style="width:650px">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="159"><span style="line-height:1.5em;font-family:Arial,Helvetica,sans-serif;color:#999999;font-size:8pt"><?php echo $current_date; ?></span></td>
                                </tr>
                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="540" style="font-size:10pt;font-family:'Arial','sans-serif'"><p> <span style="font-family:georgia,palatino;font-size:12pt;color:#800000"><br />
                                                        ...
                                                        <p> <span style="font-family:georgia,palatino;color:#800000;font-size:12pt">The Studionear Team. </span> </p>
                                                        ...
                                                        <p style="text-align:center"> <span style="font-family:arial,helvetica,sans-serif;font-size:10pt;color:#999999"> Web Address : <a href="http://www.studionear.com">www.studionear.com </a> </span> <span style="font-family:arial,helvetica,sans-serif;font-size:10pt;color:#999999"> <br>
                                                                    Email Us : info@studionear.com <br>
                                                                        Please do not reply to this email. <a target="_blank" style="color:#336699" title="Contact the White House" href="http://studionear.com/beta/welcome/help">Contact the Studionear Team</a> </span> </p>
                                                                        <p style="text-align:center"> <span style="font-family:arial,helvetica,sans-serif;font-size:10pt;color:#999999">  </span> </p>
                                                                        </td>
                                                                        <td width="55"></td>
                                                                        </tr>
                                                                        </tbody>
