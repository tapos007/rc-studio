...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>latestMain/css/custom_style_home.css" type="text/css">
        ...
        <div class="modal fade" id="press" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h3 class="modal-title" id="myModalLabel">Press..</h3>
                    </div>
                    <div class="modal-body">
                        <p style="font-size : 20px">“StudioNear is in Beta and does not contain any press info for now.”
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav mainmenu">
                                ...
                                <li><a href="<?php echo base_url(); ?>welcome/how_it_works">How It Works</a></li>
                            ...
                            <ul class="nav navbar-nav navbar-right">                   
                                ...
                                <li style="padding-top:5px !important;"> <button class="btn btn-warning btn-lg" data-toggle="modal" data-target="#betaText">BETA</button></li>
                            </ul>
                        </div><!-- /.navbar-collapse -->
                    </div>
                </nav>
                <nav class="navbar nav-bg-less" role="navigation" id="navsan">
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>latestMain/images/logo/footerLogo.png"></a>
                        </div>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img class="img-responsive img1" src="<?php echo base_url(); ?>latestMain/images/bg-pattern/frontpage1.jpg" alt="First slide">
                    <div class="container">
                        <div class="carousel-caption" style="color:black; font-size: 10px;">
                            <a href="http://upload.wikimedia.org/wikipedia/commons/9/95/Studio_Booth_at_Studio_3.jpg"> “日本語: Studio Booth at Studio 3" </a> by JacoTen (Own Work) is licensed under <a href="http://creativecommons.org/licenses/by-sa/3.0">CC BY 3.0 </a> , via Wikimedia Commons, desaturated from original.  The licensor does not necessarily endorse StudioNear or its use of the work. 
                        </div>
                    </div>
                </div>
                <div class="item">
                    <img class="img-responsive img1" src="<?php echo base_url(); ?>latestMain/images/bg-pattern/frontpage2.jpg" alt="Second slide">
                    <div class="container">
                        <div class="carousel-caption" style="color:black; font-size: 10px;">
                            <a href="http://upload.wikimedia.org/wikipedia/commons/a/ac/Studio_A.jpg">Live Room of Studio A, Fantasy Studios"</a> by Skallikat (Own Work) is licensed under <a href="http://creativecommons.org/licenses/by-sa/3.0">CC BY 3.0 </a> , via Wikimedia Commons, desaturated from original.  The licensor does not necessarily endorse StudioNear or its use of the work.
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <img class="center-block" src="<?php echo base_url(); ?>latestMain/images/man.png" alt="img1">                            
                                    ...
                                    <div class="centered"><p>  <button class="btn btn-warning btn-lg" data-toggle="modal" data-target="#aboutUs">
                                                Learn More
                                            </button></p></div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <img class="center-block" src="<?php echo base_url(); ?>latestMain/images/gift.png" alt="img1">                            
                                    ...
                                    <div class="centered"><p> <button class="btn btn-warning btn-lg" data-toggle="modal" data-target="#saveYoutArt">
                                                Learn More
                                            </button></p></div>                              
                                </div>
                            </div>
                        ...
                        <div class="thumbnail">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="centered"><p> <button class="btn btn-warning btn-lg" data-toggle="modal" data-target="#learnTo">
                                                Learn More
                                            </button></p></div>                              
                                </div>
                            </div>
        ...
        <footer>
            ...
            <div class="row footer-SecondPart">
                <div class="container">
                    ...
                    <div class="col-lg-3 col-md-6 col-xs-6">
                        <h5>Learn More ...</h5>
                        <p><a href="" data-toggle="modal"  data-target="#feedback">Feedback</a></p>
                        <p><a href="<?php echo base_url(); ?>welcome/how_it_works">How It Works</a></p>
                        <p><a href="#" data-toggle="modal"  data-target="#aboutUs">About Us</a></p>
                    </div>
                    <div class="col-lg-3 col-md-6 col-xs-6">
                        <h5>Get Started</h5>
                        <p> <a href="" data-toggle="modal"  data-target="#myModal">Login</a></p>
                        <p><a href="" data-toggle="modal"  data-target="#regModel">Join</a></p>
                    </div>
