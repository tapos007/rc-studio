...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <p><strong>STUDIO  NEAR, LLC </strong><br />
            <strong>Last  Edit:  February 7, 2014</strong></p>
        <p>&nbsp;</p>
        ...
        <p>You agree not to utilize  any data mining, data gathering or extraction tools or any manual systems to  collect, gather, or copy any data on or related to the Services in a manner not  previously authorized in writing by Studio. You may not use &ldquo;hidden text&rdquo; or  meta-tags incorporating the Studio name or trademarks without first obtaining Studio&rsquo;s  express written consent.<br />
            <strong>4.</strong>  <strong>USER SUBMISSIONS</strong>. Content submitted by Users on the Product (including,  but not limited to, any expressions, information, and/or data submitted on the  profile pages, message boards, forums, webcam sessions or other public areas of  the Product) is referred to in these Terms of Service as &ldquo;User Submissions.&rdquo; User  Submissions are subject to these Terms of Service, whether they are published  or not.  Studio does not guarantee any  confidentiality with respect to a User Submission. You are solely responsible  for your own User Submissions and the outcome and consequences of posting or  publishing them. You represent and warrant that you own or have the necessary authorization,  licenses, rights, permissions and/or consents to any intellectual properties  within your User Submissions.  You hereby  grant Studio the right to use User Submissions in the manner laid out by these  Terms of Service, within the Privacy Policy, and elsewhere within the Product  and/or Services.<br />
            You hereby grant Studio  a royalty-free, non-exclusive, worldwide, everlasting license, with the right  to publicly display, recreate, distribute, reproduce, transmit, broadcast,  telecast, webcast, create derivative works of, any or all of User Submissions   on the Product and/or through the Services.  You also authorize Studio to use your image, name,  and likeness in connection with the submitted content for the use of marketing,  advertising, or other promotional material.   You agree that you shall have no recourse against Studio (including its  agents, employees, affiliates, and the like) nor hold Studio (nor its agents,  employees, affiliates, and the like) liable for any alleged or actual  infringement, appropriation, and/or dilution of any proprietary rights in any  and all submissions to Studio.  <br />
        ...
        <p>&nbsp;</p>
        <p>You agree to hold Studio harmless and take sole responsibility  and liability for User Submissions made on your Account, or by use of your  Account.</p>
        <ol>
            <li>You agree to use the  Services at your own risk.</li>
            <li>You agree not to enter  into any webcam space with anyone you have reason to believe may be below the  age of 25 years old if you are now, or if you have ever been, a registered sex  offender.</li>
        </ol>
        ...
        <ol>
            ...
            <ol>
                <li>Instructor &ldquo;no shows&rdquo; or begins the session more than 10 minutes after  the regularly scheduled time.</li>
        ...
        <p>Since the instructors set the value of  their own Class Fees these fees are subject to change with our without prior  notice from time to time.  Students,  however, will not be affected by price changes that occur after enrollment for  that given class.  <br />
        ...
        <p><strong>9.  DISSATISFACTION WITH A  CLASS</strong>.  For full rules, see our Dispute Resolution  Policy.</p>
        <p>In the event that a student is  dissatisfied with a session a complaint may be submitted through our Product in  the form of a ticket.  Studio&rsquo;s customer  service agent will then look into the issue described on the ticket.  A simple dissatisfaction does not constitute  a refund for the class.  Each situation  will be reviewed on a case-by-case basis and a determination will be made by  Studio&rsquo;s sole discretion.  All complaint  tickets from students must be submitted no later than two (2) days after the  session; otherwise, Studio will be unable to take any action and student will  have to handle the matter directly with instructor.  </p>
        ...
        <p><strong>21.  SEVERABILITY</strong>.   In the event that a court may deem any portion of this Terms of Service  to be unenforceable, the remainder of the Terms of Service will remain valid  and in full force.  <br />
            &nbsp;&nbsp;<br />
            <strong>22.&nbsp; NETWORK CONNECTIVITY. </strong>Studio does  not guarantee nor control the Internet or data bandwidth associated with your  mobile devices. </p>
