            ...
            <div class="form-group">
                <table class="table table-striped table-bordered" id="addRow">
                    ...
                    <tbody >
                        ...
                        <tr>
                            <td>
                                <select id="DaysInWeek" name="day<?php echo $i; ?>" class="form-control">
                                    <option value="Monday" <?php
                                    if ($schedule_info->Day == 'Monday') {
                                        echo 'selected';
                                    }
                                    ?>>Monday</option>
                                    <option value="Tuesday" <?php
                                    if ($schedule_info->Day == 'Tuesday') {
                                        echo 'selected';
                                    }
                                    ?>>Tuesday</option>
                                    <option value="Wednesday" <?php
                                    if ($schedule_info->Day == 'Wednesday') {
                                        echo 'selected';
                                    }
                                    ?>>Wednesday</option>
                                    <option value="Thursday" <?php
                                    if ($schedule_info->Day == 'Thursday') {
                                        echo 'selected';
                                    }
                                    ?>>Thursday</option>
                                    <option value="Friday" <?php
                                    if ($schedule_info->Day == 'Friday') {
                                        echo 'selected';
                                    }
                                    ?>>Friday</option>
                                    <option value="Saturday" <?php
                                    if ($schedule_info->Day == 'Saturday') {
                                        echo 'selected';
                                    }
                                    ?>>Saturday</option>
                                    <option value="Sunday" <?php
                                    if ($schedule_info->Day == 'Sunday') {
                                        echo 'selected';
                                    }
                                    ?>>Sunday</option>													
                                </select>
