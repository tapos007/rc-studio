...
$('#mncategory').on('change', function(e) {
	var jobCatName = $(this).val();
	/*$.ajax({
		type: "POST",
		url: "<?php echo base_url(); ?>welcome/getSubCategoryByCategory",
	...
	var loadUrl = '<?php echo site_url('welcome/getSubCategoryByCategory'); ?>';
        if (jobCatName != undefined) {
            $("#subcategory").html('Loading....').load(loadUrl + "/" + jobCatName);
        }
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="controls col-sm-10">
                            <select name="category"  id="mncategory"  class="form-control">
