...
<div class="col-lg-12">
    ...
    <h2> You are at <strong>Sent Item</strong> <h2>
                ...
                <tbody>
                    ...
                    foreach ($MessageAllGrouped['retval'] as $MessageAll) {
                        ...
                        foreach ($MessageAll['messages'] as $MessageB) {
                            ...
                            $SQLComm = "SELECT mp.user_id, u.username from msg_participants AS mp INNER JOIN users u ON u.email = mp.user_id WHERE user_id <> '" . $email . "' and thread_id = '" . $MessageB['thread_id'] . "'";
                                ...
                                if ($MessageB['sender_id'] != $email) {
                                    ...
                                    <tr>
                                        <td style = "border:0px;">
                                            ...
                                            <a href="<?php echo site_url('messaging/read_single_message_all_threads/' . $MessageB['id'] . '/' . base64_encode($email)); ?>" class="dropdown-menu-sub-footer">

                                                <b>
                                                    <?php
                                                    echo substr($receiptionist, 0, 20);  //substr($MessageB['username'], 0, 20);
                                                    if ($i != 1)
                                                        echo " (" . $i . ")";
                                        ...
                                        if ($MessageB['status'] == 0) { //If Un-read
                                            ...
                                            <td style = "border:0px;"><span class="title" style= "text-align:left; font-size:13px;"><span class="label label-info"> new </span> <b> &nbsp;&nbsp;
                                                        ...
                                                        <?php echo substr($MessageB['subject'], 0, 80) . " ... ... ..."; ?> </b><span class="date">
                                                        </b> </span></td>
                                            </a>
                                            <td style = "border:0px;">
                                                ...
                                                <span class="date">
                                                    ...
                                                    <?php echo date('M d', (strtotime($MessageB['cdate']))); ?> <b><?php echo "(" . date('H:i:s', (strtotime($MessageB['cdate']))) . ")"; ?></b></span> </td>
                                            <?php
                                        } else {
                                            ?>
                                            ...
                                            <td style = "border:0px;">
                                                <a href="<?php echo site_url('messaging/read_single_message_all_threads/' . $MessageB['id'] . '/' . base64_encode($email)); ?>" style="padding-top: 5px;">
                                                    ...
                                                    <span class="title" style= "text-align:left; font-size:13px;">
                                                        <?php echo substr($MessageB['subject'], 0, 80) . " ... ... ..."; ?>
                                                    </span>
                                                </a>
                                            </td>
                                            <td style = "border:0px;">
