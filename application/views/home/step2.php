    ...
    $(document).ready(function() {
        ...
        $("#step2").validate({
            ...
            messages: {
                ...
                termNCcondition: "Please accept our policy"
            }
        });
    });</script>
<div class="row" style="color: white;">
    <div class="col-lg-12" style="margin-top:50px; margin-bottom: 40px;">
        <?php
        $attributes = array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'step2');
        echo form_open('welcome/step2', $attributes);
        ?>
        ...
        <div class="form-group">
            <label for="Address" class="col-sm-2 control-label">Address Line1</label>
            <div class="col-sm-10">
                <input type="text" name="Address" id="Address" class="form-control" value="<?php echo set_value('Address'); ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="Address" class="col-sm-2 control-label">Address Line2</label>
            <div class="col-sm-10">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text"  name="City" id="City"  class="form-control datepicker" value="<?php echo set_value('City'); ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="State" class="col-sm-2 control-label">State</label>
            <div class="col-sm-10">
                <select id="State" name="State" class="form-control" value="<?php echo set_value('State'); ?>" >
                    ...
                    <option value="NT">Tennessee</option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="Country" id="Country" class="form-control" readonly="readonly" value="United States" >
            </div>
        </div>
        <div class="checkbox col-sm-offset-2">
            <label>
                <input type="checkbox" value="agree" id='termNCcondition' name="termNCcondition" >  I have read and agree to the <a href="" data-toggle="modal"  data-target="#ToR">terms of use and privacy policy</a>
            </label>
        </div>
        <br />
        <div class="form-group">
