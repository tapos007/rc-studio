...
!function() {
    ...
    SelectParser = function() {
        ...
        return SelectParser.prototype.add_node = function(a) {
            ...
            var b, c, d, e, f, g;
            for (b = this.parsed.length, this.parsed.push({array_index:b, group:!0, label:a.label, children:0, disabled:a.disabled}), f = a.childNodes, g = [], d = 0, e = f.length; e > d; d++)
    ...
    a = this, AbstractChosen = function() {
        ...
        return AbstractChosen.prototype.set_default_values = function() {
            ...
            for (b = "", f = this.results_data, d = 0, e = f.length; e > d; d++)
                c = f[d], c.group && c.search_match ? b += this.result_add_group(c) : !c.empty && c.search_match && (b += this.result_add_option(c)), (null != a ? a.first : void 0) && (c.selected && this.is_multiple ? this.choice_build(c) : c.selected && !this.is_multiple && this.single_set_selected_text(c.text));
            return b
        }, AbstractChosen.prototype.result_add_option = function(a) {
            var b, c;
            return a.dom_id = this.container_id + "_o_" + a.array_index, b = [], a.disabled || a.selected && this.is_multiple || b.push("active-result"), !a.disabled || a.selected && this.is_multiple || b.push("disabled-result"), a.selected && b.push("result-selected"), null != a.group_array_index && b.push("group-option"), "" !== a.classes && b.push(a.classes), c = "" !== a.style.cssText ? ' style="' + a.style + '"' : "", '<li id="' + a.dom_id + '" class="' + b.join(" ") + '"' + c + ">" + a.search_text + "</li>"
            ...
            for (this.no_results_clear(), f = 0, g = this.get_search_text(), e = this.search_contains?"":"^", d = new RegExp(e + g.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "i"), j = new RegExp(g.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "i"), o = this.results_data, k = 0, m = o.length; m > k; k++)
                if (a = o[k], !a.empty)
                    if (a.group)
                        a.search_match = !1;
                    else {
                        if (a.search_match = !1, d.test(a.html))
                            a.search_match = !0, f += 1;
                        else if (this.enable_split_word_search && (a.html.indexOf(" ") >= 0 || 0 === a.html.indexOf("[")) && (c = a.html.replace(/\[|\]/g, "").split(" "), c.length))
                            for (l = 0, n = c.length; n > l; l++)
                                b = c[l], d.test(b) && (a.search_match = !0, f += 1);
                        a.search_match && (g.length ? (h = a.html.search(j), i = a.html.substr(0, h + g.length) + "</em>" + a.html.substr(h + g.length), i = i.substr(0, h) + "<em>" + i.substr(h)) : i = a.html, a.search_text = i, null != a.group_array_index && (this.results_data[a.group_array_index].search_match = !0))
                    }
            return 1 > f && g.length ? (this.update_results_content(""), this.no_results(g)) : (this.update_results_content(this.results_option_build()), this.winnow_results_set_highlight())
    ...
    b = this, a = jQuery, a.fn.extend({chosen: function(b) {
        ...
        return e(Chosen, d), Chosen.prototype.setup = function() {
            ...
            var c, d;
            return d = this.results_data[b], this.form_field.options[d.options_index].disabled ? !1 : (d.selected = !1, this.form_field.options[d.options_index].selected = !1, this.selected_option_count = null, c = a("#" + this.container_id + "_o_" + b), c.removeClass("result-selected").addClass("active-result").show(), this.result_clear_highlight(), this.results_showing && this.winnow_results(), this.form_field_jq.trigger("change", {deselected: this.form_field.options[d.options_index].value}), this.search_field_scale(), !0)
            ...
            var b, c, d, e, f, g, h, i;
            if (this.is_multiple) {
                for (c = 0, g = 0, e = "position:absolute; left: -1000px; top: -1000px; display:none;", f = ["font-size", "font-style", "font-weight", "font-family", "line-height", "text-transform", "letter-spacing"], h = 0, i = f.length; i > h; h++)
            ...
            var b;
            for (b = "sel" + this.generate_random_char() + this.generate_random_char() + this.generate_random_char(); a("#" + b).length > 0; )
