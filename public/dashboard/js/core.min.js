...
jQuery(document).ready(function(a) {
    if (a(".boxchart")) {
        if (retina()) {
            a(".boxchart").sparkline("html", {type: "bar", height: "60", barWidth: "8", barSpacing: "2", barColor: "#fff", negBarColor: "#eeeeee"});
            a(".boxchart").css("zoom", 0.5)
        } else {
            a(".boxchart").sparkline("html", {type: "bar", height: "30", barWidth: "4", barSpacing: "1", barColor: "#fff", negBarColor: "#eeeeee"})
        }
    }
});
jQuery(document).ready(function(a) {
    a(".todo-actions > a").click(function() {
        if (a(this).find("i").attr("class") == "icon-check-empty") {
            ...
            a(this).parent().parent().find("span").css({opacity: 0.25});
            ...
            a(this).parent().parent().find("span").css({opacity: 1});
